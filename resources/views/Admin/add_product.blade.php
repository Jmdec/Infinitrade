            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Add Product /</span> Modals
                        </h4>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            <div class="dropdown me-3">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                    <li><a class="dropdown-item" href="#" onclick="exportTable('csv')">Export
                                            to CSV</a></li>
                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset($product->image) }}" alt="{{ $product->product_name }}"
                                                style="width: 100px; height: auto;"></td>
                                        <td>Php{{ number_format($product->price, 2) }}</td>
                                        <td>Php{{ number_format($product->discounted_price, 2) }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Add Your Product Here</h5>
 ...
 <script>
    ...
    },
    {
        ...
        function exportTable(type) {
            // Trigger export from DataTable
            $('#productTable').DataTable().button(type === 'csv' ? 0 : 1).trigger();
        }
    </script>
</html>
